...
export default function PPFSPage() {
  ...
  // Get PPFS KPIs
  const ppfsKPIs = kpiMaster.filter(k => k.category === "PPFS");

  // Filter results
  const filteredResults = kpiResults.filter(r => {
    const matchesCategory = r.category === "PPFS";
    ...
    <div className="space-y-6 animate-fade-in">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Pregnancy, Post-partum, Family Planning & Screening
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card className="card-hover md:col-span-2">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg">รายการตัวชี้วัด PPFS</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              {ppfsKPIs.map((kpi) => (
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-lg font-bold text-primary">{kpi.targetPercent}%</p>
                  </div>
                </div>
              ))}
            </div>
